...
brands = ["Maybelline", "Brand B", "Brand C", "Brand D", "Brand E"]
quality_options = ["1 ", "2", "3", "4", "5 (excellent)"]
price_options = ["1", "2", "3", "4", "5 (affordable)"]
...
def create_poll():
    # Show the question for the poll
    st.header("Which brand do you prefer?")
...
st.title("Brand preference poll")
